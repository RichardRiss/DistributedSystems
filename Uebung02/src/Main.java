public class Main {
    public static void main(String[] args) {
        ...
        //client.normal_socket("stud.fh-wedel.de", 80);

        //Client with URL socket class
        //client.url_socket("http://stud.fh-wedel.de/index.html");

        //Client with proxy
        //client.url_socket("http://www.stud.fh-wedel.de/index.html", "92.222.237.109", 8888);
